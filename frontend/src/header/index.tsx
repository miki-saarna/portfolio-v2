  ...
  return (
    <>
      <div className="max-w-2xl lg:max-w-6xl mx-auto flex justify-between items-center h-16 lg:h-24 p-6 lg:px-12">
        <NavLink to="/" className="text-5xl lg:text-6xl font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-800 focus-visible:ring-offset-1 dark:focus-visible:ring-gray-700 dark:ring-offset-[#111827]">miki</NavLink>
