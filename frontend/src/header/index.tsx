...
function App({ darkMode, setDarkMode, setMobileNavMenuOpen }: { darkMode: boolean, setDarkMode: Function, setMobileNavMenuOpen: Function }): JSX.Element {
  return (
    <div className="max-w-2xl lg:max-w-6xl mx-auto flex justify-between items-center h-16 lg:h-24 p-6 lg:px-12">
      ...
      <button onClick={() => setMobileNavMenuOpen(true)} className="lg:hidden w-6 h-6">
        <Bars3Icon />
      </button>
    </div>
  );
