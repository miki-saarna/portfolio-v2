...
export default function Bio(): JSX.Element {
  return (
    <div className="max-w-2xl lg:max-w-6xl mx-auto flex flex-col items-center p-6 lg:px-12 text-gray-600 dark:text-gray-300">
      ...
      <div className="mt-4 lg:max-w-xl text-center">I'm a fullstack software engineer with 3 years of experience, specializing in frontend, but eager to continue learning backend.</div>
      <Tabs />
