    ...
    <div className="flex flex-col space-y-6 divide-y mt-6 lg:mt-0 lg:ml-12">
      <div className="flex">
        ...
        <div className="flex flex-col text-left">
          ...
          <div className="mt-1 text-sm text-text-light">Jan 2024 - Feb 2024</div>
        </div>
      </div>
      <div className="flex pt-6">
        ...
        <div className="flex flex-col text-left">
          ...
          <div className="mt-1 text-sm text-text-light">Jan 2024</div>
        </div>
      </div>
      <div className="flex pt-6">
        <div className="min-w-8 mr-6">   
        ...
        <div className="flex flex-col text-left">
          ...
          <div className="mt-1 text-sm text-text-light">Jun 2022</div>
        </div>
      </div>
    </div>
  )
